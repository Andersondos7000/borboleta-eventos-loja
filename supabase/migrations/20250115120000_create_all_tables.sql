...
-- 6. Tabela orders será criada em migração específica (20250125000000_consolidate_orders_tables.sql)
-- Removido para evitar conflitos de migração
...
-- Trigger para orders será criado em migração específica (20250125000000_consolidate_orders_tables.sql)
...
-- RLS para orders será habilitado em migração específica (20250125000000_consolidate_orders_tables.sql)
...
-- Políticas para orders serão criadas em migração específica (20250125000000_consolidate_orders_tables.sql)
