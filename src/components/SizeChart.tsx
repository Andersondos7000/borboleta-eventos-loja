...
const SizeChart: React.FC<SizeChartProps> = ({ type }) => {
  const sizeData = {
    ...
    vestido: {
      ...
      bust: ['78-80', '82-84', '86-88', '90-92', '94-96', '98-102', '104-108', '110-114', '116-122', '124-130'],
      waist: ['58-60', '62-64', '66-68', '70-72', '74-76', '78-82', '84-88', '90-94', '96-102', '104-110'],
      hips: ['84-86', '88-90', '92-94', '96-98', '100-102', '104-108', '110-114', '116-120', '122-128', '130-136'],
    }
  };
