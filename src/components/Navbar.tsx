...
import { ShoppingCart, Calendar, Shirt, User, Brain } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Link to="/ia" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-butterfly-orange/10 transition-colors flex items-center">
